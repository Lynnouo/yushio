...
4. **Four Layered Skills** (`#skills`) — base / art-director / auditor / parallel cards
...
7. **Install** (`#install`) — terminal command, four trigger phrases, 7-tool compatibility matrix, final CTA
