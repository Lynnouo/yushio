...
4. **Three Layered Skills** (`#skills`) — base / art-director / auditor cards
5. **Before / After** (`#compare`) — 6 scenarios in a comparison table (collapses to cards on mobile)
6. **Origin** (`#origin`) — central quote + 3-paragraph body + 5-phase timeline + 3 creator credits
7. **Install** (`#install`) — terminal command, three trigger phrases, 7-tool compatibility matrix, final CTA
